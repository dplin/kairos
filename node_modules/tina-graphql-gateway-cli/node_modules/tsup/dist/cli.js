...
async function main() {
  ...
  cli.command("[...files]", "Bundle files", {
    ...
    const options = _chunk3MVIR5D3js.__assign.call(void 0, {}, flags);
    if (files.length > 0) {
...
main().catch(_chunk3MVIR5D3js.handleError);
