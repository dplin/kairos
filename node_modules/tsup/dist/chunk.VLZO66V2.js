...
var _chunkG2NS2WYXjs = require('./chunk.G2NS2WYX.js');
...
var require_sourcemap_codec_umd = __commonJS((exports, module) => {
  (function(global2, factory) {
    typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global2 = global2 || self, factory(global2.sourcemapCodec = {}));
  })(exports, function(exports2) {
    "use strict";
    var charToInteger = {};
...
var require_rewrite_pattern = __commonJS((exports, module) => {
  ...
  var getUnicodePropertyValueSet = (property, value) => {
    ...
    try {
      return require(`regenerate-unicode-properties/${path3}.js`);
    } catch (exception) {
...
joycon.addLoader({
  ...
  async load(filepath) {
    try {
      const content = import_strip_json_comments.default(await _fs2.default.promises.readFile(filepath, "utf8"));
      return import_parse.parse(content);
    } catch (error) {
...
async function runEsbuild(options, {format}) {
  ...
  if (result && result.outputFiles) {
    ...
    const {transform} = await Promise.resolve().then(() => require("sucrase"));
      ...
      if (comeFromSource) {
        if (options.babel) {
          ...
          if (babel) {
            ...
            throw new (0, _chunkG2NS2WYXjs.PrettyError)(`@babel/core is not found in ${process.cwd()}`);
          }
        }
        if (options.target === "es5") {
          try {
            contents = import_buble.transform(contents, {
              source: file.path,
              file: file.path,
              transforms: {
                modules: false,
            ...
            throw new (0, _chunkG2NS2WYXjs.PrettyError)(`Error compiling to es5 target:
${error.snippet}`);
          }
        }
        if (format === "cjs") {
...
async function build(options) {
  ...
  if (options.entryPoints.length === 0) {
    throw new (0, _chunkG2NS2WYXjs.PrettyError)(`Cannot find ${input}`);
  }
  let watcher;
  ...
  try {
    ...
    if (tsconfig.path && tsconfig.data) {
      ...
      if (!options.target) {
        options.target = (_a = tsconfig.data.compilerOptions) == null ? void 0 : _a.target;
      }
      if (options.target) {
...
exports.__commonJS = __commonJS; exports.makeLabel = makeLabel; exports.__toModule = __toModule; exports.runEsbuild = runEsbuild; exports.build = build;
